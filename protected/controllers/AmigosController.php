...
class AmigosController extends Controller
{
	...
	public function actionIndex()
	{
		...
		if(Yii::app()->user->name == 'admin')
		{
			...
			$this->render('index', array('resultados' => Amigos::model()->findAll($criteria)));
		}else
		{			
	...
	{
		$model=new Amigos('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Amigos']))
			$model->attributes=$_GET['Amigos'];
	...
	{
		$model=Amigos::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='amigos-form')
		{
